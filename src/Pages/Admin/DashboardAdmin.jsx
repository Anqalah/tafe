      ...
      <div className="space-y-6 lg:space-y-8 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="space-y-2">
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-sm border border-gray-400/50 lg:p-6 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-2 lg:space-y-3 max-h-60 lg:max-h-96 overflow-y-auto">

    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2A4365]/5 to-[#D4AF37]/5 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#2A4365] font-medium">Memuat data profil...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2A4365]/5 to-[#D4AF37]/5 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <ErrorModal
        ...
        message="Gagal memperbarui profil. Silakan cek koneksi atau data input."
      />
      ...
      <ConfirmDialog
        ...
        message={`Apakah Anda yakin ingin menyimpan perubahan untuk profil "${formData.name}"?`}
        confirmText="Ya, Simpan"
        cancelText="Batal"
        variant="pending"
      />

      <LoadingModal isOpen={showLoading} message="Menyimpan data profil..." />
